    ...
    <main>
        ...
        ?>
            <div class='container mt-5 text-center'>
                <div class='row'>
                    <h2 class='fs-2 fw-bold'>You are not Logged</h2>
                </div>
                <div class='row d-flex justify-content-center'>
                    <div class='col'>
                        <a href='Validate.php' class='btn btn-outline-success me-2'>Login</a>
                    </div>
                    <div class='col'>
        ...
        ?>
            <script type="module" src="../Scripts/ConfirmController.js"></script>
            <div class="container d-flex flex-column justify-content-center mt-5 " id="container-confirm">
            </div>
        <?php
        }
        ?>
