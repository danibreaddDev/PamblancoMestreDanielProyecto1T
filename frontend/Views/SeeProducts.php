...
<body>
    ...
    <main>
            ...
            <div id="carouselExampleRide" class="carousel slide" data-bs-ride="true">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="../imgs/scarlet36-1.jpg" class="img-fluid" alt="img-1">
                    </div>
                   
                    <div class="carousel-item">
                        <img src="../imgs/descarga 3.jpeg" class="img-fluid" alt="img-2">
                    </div>
                    <div class="carousel-item">
                        <img src="../imgs/descarga (2).jpeg" class="img-fluid" alt="img-3">
                    </div>
                </div>
                <button class="carousel-control-prev" type="button" data-bs-target="#carouselExampleRide" data-bs-slide="prev">
                    <span class="carousel-control-prev-icon" aria-hidden="true"  style="background-color:#69E277;"></span>
                    <span class="visually-hidden">Previous</span>
                </button>
                <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleRide" data-bs-slide="next">
                    <span class="carousel-control-next-icon" aria-hidden="true" style="background-color:#69E277;"></span>
        ...
        <div class='container mt-5 text-center'>
            <div class='row d-flex gy-4' id="container-products">
                <?php
                $salida = "";
                $imagen = "";
                $nombre = "";
                ...
                foreach ($products as $product) {
                    $salida .= "<div class='col-12 col-md-6 col-xl-3'>";
                    $salida .= " <div class='card h-100'>";
                    $salida .= " <img src='" . $product["foto"] . "' class='img-fluid' alt='Imagen del producto'>";
                    $salida .= "<div class='card-body d-flex flex-column justify-content-end h-100'>";
                    $salida .= "<h5 class='card-title '>" . $product["nombre"] . "</h5> ";
                    $salida .= "<p class='card-text subtitle'>Price: " . $product["precio"] . " €</p>";
                    $salida .= "<div>";
                    $salida .= "<a class='btn btn-outline-success' href='Details.php?idProducto=" . $product["idProducto"] . "'>See details</a>";
                    $salida .= " </div>";
                    $salida .= " </div>";
                    $salida .= " </div>";
                    $salida .= " </div>";
